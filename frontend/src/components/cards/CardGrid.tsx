...
type Props = {
  ...
  /** Кастомная высота карточки (tailwind-класс), напр. "min-h-[180px]" */
  minH?: string;
};
        ...
        <div className={clsx('hcard-body p-6 relative', minH)}>
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3 hcard-layer hcard-ico">
              ...
              <div className="hcard-title text-lg hcard-layer hcard-ttl">
                {title}
              </div>
            </div>
            {desc && (
              <div className="hcard-desc mt-2 hcard-layer hcard-dsc">{desc}</div>
            )}
